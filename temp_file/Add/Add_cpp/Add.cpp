...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 4]); // line circom 9
// end load src
...
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 0],&circuitConstants[1]); // line circom 11
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 0; i++){
