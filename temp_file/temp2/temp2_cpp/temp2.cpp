...
Fr_sub(&expaux[3],&signalValues[mySignalStart + 2],&circuitConstants[1]); // line circom 9
Fr_mul(&expaux[1],&signalValues[mySignalStart + 2],&expaux[3]); // line circom 9
...
// load src
Fr_sub(&expaux[4],&signalValues[mySignalStart + 1],&circuitConstants[1]); // line circom 10
Fr_mul(&expaux[2],&signalValues[mySignalStart + 2],&expaux[4]); // line circom 10
Fr_add(&expaux[0],&circuitConstants[1],&expaux[2]); // line circom 10
// end load src
