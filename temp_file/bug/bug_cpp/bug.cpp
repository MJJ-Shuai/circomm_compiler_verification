...
Fr_sub(&expaux[3],&signalValues[mySignalStart + 2],&circuitConstants[0]); // line circom 7
Fr_mul(&expaux[1],&signalValues[mySignalStart + 2],&expaux[3]); // line circom 7
Fr_eq(&expaux[0],&expaux[1],&circuitConstants[1]); // line circom 7
...
// load src
Fr_sub(&expaux[4],&signalValues[mySignalStart + 1],&circuitConstants[0]); // line circom 8
Fr_mul(&expaux[2],&signalValues[mySignalStart + 2],&expaux[4]); // line circom 8
Fr_add(&expaux[0],&circuitConstants[0],&expaux[2]); // line circom 8
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_eq(&expaux[0],&signalValues[mySignalStart + 0],&circuitConstants[1]); // line circom 9
